...
export const HeaderCommunicationGoal = ({
    ...
    return (
        <div className='w-full px-6'>
            <div className='w-full bg-white/50 rounded-[30px] px-[10px] h-[30px] flex items-center justify-start gap-x-2.5 transition duration-300 active:scale-95 shadow-black shadow-2xl'>
